...
export default function TicketsScreen() {
  ...
  const { user } = useAuth();
//   const [tickets] = useQuery(ZERO_QUERIES.assignedTickets({userID: user?.id || ''}));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <ThemedText style={styles.headerTitle}>Assigned Tickets</ThemedText>
      ...
      >
        {filteredTickets.map((ticket) => (
          <Pressable
            ...
            onPress={() => router.push({
              pathname: '/assigned-ticket-detail',
              params: ticket
            })}
          >
