...
export type TicketStatus = 'new' | 'assigned' | 'in_progress' | 'waiting_supervisor' | 'resolved' | 'closed' | 'reopened';
export type TicketEventType = 'created' | 'assigned' | 'status_changed' | 'comment' | 'escalated' | 'resolved' | 'closed' | 'reopened';
